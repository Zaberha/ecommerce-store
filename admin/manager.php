...
if (hasAccess('orders', $privileges)) {
    // Fetch total sales
    ...
    $total_orders = $conn->query("
        ...
        FROM orders 
        WHERE order_status = 'completed'
    ")->fetch(PDO::FETCH_ASSOC)['total_orders'] ?? 0;

    $total_pending_orders = $conn->query("
        SELECT COUNT(*) AS total_orders 
        FROM orders 
...
if (hasAccess('products', $privileges)) {
...
if (hasAccess('customers', $privileges)) {
    // Fetch Leaders Board
...
<!-- Then Popper.js (required for dropdowns) -->
...
<div class="main-content" id="mainContent">
        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="manager.php">Dashboard</a></li>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Manager Dashboard Overview</h1>
            <?php if (hasAccess('reports', $privileges)): ?>
        ...
        <!-- Stats Cards -->
        <?php if (hasAccess('orders', $privileges)): ?>
        <div class="row mb-4">
            <!-- Total Sales Card -->
                ...
                <div class="card stat-card primary h-100 py-2 border-left-primary">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-third text-uppercase mb-1">Total Sales</div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card stat-card success h-100 py-2 border-left-success">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-second text-uppercase mb-1">Completed Orders</div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card stat-card warning h-100 py-2 border-left-warning">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-first text-uppercase mb-1">Pending Orders</div>
        ...
        <!-- Content Row -->
        <div class="row">
            <?php if (hasAccess('products', $privileges)): ?>
            <!-- Top Products -->
            ...
            <?php if (hasAccess('customers', $privileges)): ?>
            <div class="col-xl-6 col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge rounded-pill <?php switch($order['order_status']) {
